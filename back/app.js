...
app.use(express.static(path.join(directoryName, '../front/dist')));

app.get('*', (req, res) => {
  res.sendFile(path.join(directoryName, '../front/dist/index.html'));
});

app.use('/images', express.static('images')) // Make the images folder accessible
